...
namespace ECE141 {
  ...
  struct BlockHeader {
    ...
    BlockHeader() : type('D') {reserved=0; extra=0; id=0; next=0; size=0;}
    
    BlockHeader(char aType) : type(aType)  {reserved=0; extra=0; id=0; next = 0; size=0;}
  ...
  public:
    ...
    //StatusResult    markUsed(const char &aChar, uint32_t aBlockNum);
  ...
  protected:
    ...
    friend class Entity;
    friend class Index; //potentially a bad idea...
  };
