...
namespace ECE141 {
  ...
  class Value {
    public:
      ...
      friend BufferReader& operator >> (BufferReader& aReader, Value &aValue);
      friend BufferWriter& operator << (BufferWriter& aWriter, const Value &aValue);
      ...
      Value& operator=(uint32_t aValue);
