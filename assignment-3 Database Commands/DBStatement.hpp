...
namespace ECE141 {
  ...
  // USE: declare a describe DB command (describe database <name>)...
  ...
  // USE: represent Show databases statement...
  ...
  // USE: represents USE DB statement...
